package vod.entity.confcodecrecordsrv;
 ...
 */
@Entity
@Table(name = "conf_codec_recordsrv", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class ConfCodecRecordSrvEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  编码器ID
	 */
	@Column(name ="CODECID",nullable=true,length=36)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  编码器ID
	 */
	public void setCodecid(java.lang.String codecid){
		this.codecid = codecid;
	}
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  录制服务器ID
	 */
	@Column(name ="RECORDSRVID",nullable=true,length=36)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  录制服务器ID
	 */
