package vod.entity.meetinglivesession;
 ...
 * @Description: 直播会议分表
 * @author zhangdaihao
 * @date 2014-07-11 12:37:43
 * @version V1.0   
 *
 */
@Entity
@Table(name = "meeting_live_session", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class MeetingLiveSessionEntity implements java.io.Serializable {
	/**主键*/
