	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value" colspan="3">
				<textarea cols="101" rows="4" style="margin:5px auto; resize:none" id="introduction" name="introduction" ignore="ignore" value="${meetingInfoPage.introduction}"></textarea>
...
<!-- </br>
	<div>
		<table border="0" style="height:auto; width:100%; overflow: hidden;">
			<tr>
				<td align="center"><a href="javascript:void(0)" class="easyui-linkbutton" onclick="add_live()">开始直播</a></td>
				<td align="center"><a href="javascript:void(0)" class="easyui-linkbutton" onclick="add_rec()">开始录制</a></td>
				<td align="center"><a href="javascript:void(0)" class="easyui-linkbutton" onclick="del_rec()">结束录制</a></td>
				<td align="center"><a href="javascript:void(0)" class="easyui-linkbutton" onclick="del_live()">结束直播</a></td>
			</tr>
		</table>
	</div> -->
