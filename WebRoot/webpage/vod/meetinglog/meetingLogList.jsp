...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="meetingLogList" title="会议日志" actionUrl="meetingLogController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="终端MAC" field="edgemac" align="center" width="100" query="true" ></t:dgCol>
   <t:dgCol title="当前状态" field="state" align="center" hidden="false" ></t:dgCol>
   <t:dgCol title="会议" field="meetingid" align="center" width="150" ></t:dgCol>
   <t:dgCol title="是否是直播" field="isliveflag" align="center" replace="录播_0,直播_1" ></t:dgCol>
   <t:dgCol title="会议主题" field="subject" align="center" width="200" ></t:dgCol>
   <t:dgCol title="日期" field="date" formatter="yyyy-MM-dd hh:mm:ss" width="120" align="center"></t:dgCol>
